# 🎉 Fase 6 — Migração do Banco de Dados

## Instruções

Acesse o painel do Supabase e execute o SQL abaixo:
...
| Código | Desconto | Mínimo | Usos máximos | Validade |
|--------|----------|--------|--------------|----------|
| BEMVINDO10 | 10% | R$ 0 | 100 | 30 dias |
| LOTUS20 | 20% | R$ 30 | 50 | 60 dias |
| FRETE5 | R$ 5 | R$ 5 | 200 | 90 dias |

## Após Executar

O cardápio já está funcional com a interface de cupons. Após executar a migration no Supabase, os cupons estarão disponíveis para uso.